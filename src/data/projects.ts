const projects = [
  ...
  },
  {
    ...
    live: 'https://ip-geolocation-tool-lac.vercel.app/'
  },
  {
    ...
    live: 'https://github-user-finder-weld.vercel.app/'
  },
  {
  ...
  },
  {
    ...
    live: 'https://weather-app-theta-red-4nudvvfez4.vercel.app/'
  },
  {
    title: 'Z.Jobs',
    description: 'Z.Jobs - An AI-powered job matching platform that connects candidates with ideal roles using smart filters and real-time analytics, streamlining hiring for both seekers and employers.',
    image: '/z.jobs.png',
    tech: ['Next.js', 'React Hooks', 'Tailwind CSS', 'Vercel',],
    github: 'https://github.com/zeeshan-Dev-Engr/Z.jobs1',
    live: 'https://z-jobs1.vercel.app/'
  },
  {
    title: 'Todo app',
